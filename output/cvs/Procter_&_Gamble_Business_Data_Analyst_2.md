...
*   **Business Acumen:** Customer Data Analysis, Process Optimization, Stakeholder Communication, Stewardship & Compliance.
...
*   Ensure data accuracy and maintain strict compliance with internal stewardship and regulatory requirements.
*   Collaborate with cross-functional teams to implement new ideas and improve operational efficiency.
*   Automated client communication processes using Python, reducing manual workload and improving data-driven engagement.

**Administrative & Auction Support** | Nuvonic 891 | 2014 – 2021

*   Managed high-volume data capture and invoicing, ensuring meticulous attention to detail and data integrity.
*   Supported customer interactions, building a strong foundation in commercial awareness and consumer-focused service.
*   Maintained compliance documentation and administrative controls, adhering to organizational stewardship standards.

### Projects

*   **Customer Behavior Analysis:** Extracted and analyzed customer data to identify trends, resulting in targeted campaigns that significantly improved performance.
...
*   **Automation Tools:** Built Python-based tools to streamline data-heavy processes, ensuring accuracy and efficiency in reporting.
